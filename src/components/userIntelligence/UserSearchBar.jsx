...
import { SEARCH_INDEX } from '@/utils/mockUserIntelligence';

const TYPE_ICON = { creator: '✦', brand: '🏢' };

/** Global entity search — find creators, brands, emails, company names & user IDs. */
export default function UserSearchBar({ onSelect }) {
  ...
  return (
    <>
      ...
      >
        <span>🔍</span>
        <span className="flex-1 text-left">Search creators, brands, emails, IDs…</span>
      </button>
              ...
              >
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border-subtle">
                  ...
                  <input
                    ...
                    placeholder="Search creators, brands, emails, company names, IDs…"
