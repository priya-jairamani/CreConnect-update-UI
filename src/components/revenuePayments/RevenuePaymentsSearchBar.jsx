...
import { SEARCH_INDEX } from '@/utils/mockRevenuePayments';

const TYPE_ICON = { transaction: '💳', creator: '🎙️', brand: '🏢', campaign: '📋', invoice: '📄', dispute: '⚖️' };

/** Global Revenue & Payments search — transactions, creators, brands, campaigns, invoices & disputes. */
export default function RevenuePaymentsSearchBar({ onSelect }) {
  ...
  return (
    <>
      ...
      >
        <span>🔍</span>
        <span className="flex-1 text-left">Search transactions, creators, brands…</span>
      </button>
              ...
              >
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border-subtle">
                  ...
                  <input
                    ...
                    placeholder="Search transactions, creators, brands, campaigns, invoices, disputes…"
