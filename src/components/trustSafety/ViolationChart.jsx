...
/** Trust & Safety analytics chart — violation/report/fraud/dispute trend lines. */
export default function ViolationChart({ title, data, series, height = 220, type = 'area', subtitle }) {
      ...
      <div style={{ width: '100%', height }}>
        <ResponsiveContainer>
          <Chart data={data} margin={{ top: 4, right: 4, bottom: 0, left: 0 }}>
            <defs>
              {series.map((s) => (
                <linearGradient key={s.key} id={`vc-${s.key}`} x1="0" y1="0" x2="0" y2="1">
