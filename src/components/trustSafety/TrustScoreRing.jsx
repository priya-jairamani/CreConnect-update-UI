...
import { SAFETY_META, safetyStatusFor } from '@/utils/mockTrustSafety';
...
/** Radial platform/account trust & safety score with Excellent/Healthy/Warning/Critical status. */
export default function TrustScoreRing({ score, size = 88, strokeWidth = 7, showStatus = true, label = 'Safety Score' }) {
  const status = safetyStatusFor(score);
  const meta = SAFETY_META[status];
