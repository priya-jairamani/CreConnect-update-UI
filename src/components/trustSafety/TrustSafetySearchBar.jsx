...
import { SEARCH_INDEX } from '@/utils/mockTrustSafety';

const TYPE_ICON = { user: '🪪', report: '📥', case: '🔍', dispute: '⚖️', campaign: '📋', moderator: '🧑‍💼' };

/** Global Trust & Safety search — users, reports, cases, disputes, campaigns & moderators. */
export default function TrustSafetySearchBar({ onSelect }) {
  ...
  return (
    <>
      ...
      >
        <span>🔍</span>
        <span className="flex-1 text-left">Search users, reports, cases, disputes…</span>
      </button>
              ...
              >
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border-subtle">
                  ...
                  <input
                    ...
                    placeholder="Search users, reports, cases, disputes, campaigns, moderators…"
