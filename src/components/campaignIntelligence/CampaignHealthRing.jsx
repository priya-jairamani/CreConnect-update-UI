...
import { HEALTH_META, healthStatusFor } from '@/utils/mockCampaignIntelligence';
...
/** Radial campaign health score with Excellent/Healthy/Warning/Critical status. */
export default function CampaignHealthRing({ score, size = 88, strokeWidth = 7, showStatus = true, label = 'Health Score' }) {
